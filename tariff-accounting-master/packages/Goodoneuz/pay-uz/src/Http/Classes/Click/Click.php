...
class Click extends BaseGateway
{
    ...
    public function run(){
        ...
        $required_fields = [
            'service_id', 'merchant_trans_id',
            'action', 'error', 'error_note',
    ...
    private function Prepare()
    {
        ...
        $params['amount'] = $params['amount'] / 1.01;
    ...
    private function GetInfo(){
        ...
        $additional_params['merchant_info'] = ($model->client) ? $model->client->name : 'Клиент не найден';
    ...
    private function check_for_required_field($fields)
    {
        ...
        if ($arr['action'] == self::REQUEST_PREPARE || $arr['action'] == self::REQUEST_COMPLATE){
            $fields[] = 'click_trans_id';
            $fields[] = 'amount';
            $fields[] = 'click_paydoc_id';
        }
