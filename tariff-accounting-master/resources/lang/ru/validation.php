...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'sku'                   => 'код',
        'number'                => '№',
        'purchase_currency_id'  => 'валюта',
        'selling_currency_id'   => 'валюта',
        'price_currency_id'     => 'валюта',
        'currency_id'           => 'валюта',
        'payment_type_id'       => 'тип оплата',
        'amount'                => 'сумма',
        'rate'                  => 'курс',
        'datetime'              => 'время',
        ...
        'status_id'             => 'статус',
        'items'                 => 'элементы',
        'items.*.product_id'    => 'продукт',
        'items.*.material_id'   => 'сырьё',
        'items.*.quantity'   => 'количество',
        'items.*.issued_from_booked'   => 'изъятия из бронированных',
        'items.*.currency_id'    => 'валюта',
        'items.*.rate'          => 'курс',
        'items.*.price'         => 'сумма',
        'items.*.qty_weight'    => 'количество',
        'contract_provider_id'  => 'договор',
        'purchase_price'        => 'цена',
        'price'                 => 'цена',
        'selling_price'         => 'цена продажи',
        'user_id'               => 'пользователь',
        'sourceable_type'       => 'документ',
        'sourceable_id'         => 'документ №',
        'realizationable_type'  => 'документ',
        'realizationable_id'    => 'документ №',
        'Get from booked'       => 'изъятия из бронированных',
        'issued_from_booked'    => 'изъятия из бронированных',
        'console_number'        => 'пультовой номер',
        'contract_client_id'    => 'договор',
        'application_services'  => 'тарифы',
        'application_services.*.service_id' => 'тариф',
        'application_services.*.price' => 'цена',
        'transactionable_id'    => 'Заявка №',
    ],
];
