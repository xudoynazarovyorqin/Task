import { index, inventory, show, store, update, destroy } from '@/api/services';
    ...
    index({ commit }, params = {}) {
        return new Promise((resolve, reject) => {
            index(params).then(res => {
                commit("SET_LIST", res.data.result.data.services);
    ...
    inventory({ commit }, params = {}) {
        return new Promise((resolve, reject) => {
            inventory(params).then(res => {
                commit("SET_INVENTORY", res.data.result.data.services);
                resolve(res.data)
            }).catch(err => {
                reject(err.response.data)
            })
