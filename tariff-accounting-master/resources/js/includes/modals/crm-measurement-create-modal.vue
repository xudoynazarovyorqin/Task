<template>
    <modal :name="name" width="40%" height="auto" :draggable="true" @before-open="beforeOpen">
        <div class="el-dialog__header cursor-move">
            <span class="el-dialog__title">{{ $t('message.new') }} {{ $t('message.measurement') | lowerFirst }}</span>
    ...
    export default {
        ...
        methods:{
            ...mapActions({
                ...
                updateListInventory: 'measurements/inventory'
            }),
            beforeOpen(){
                        ...
                        if (valid) {
                            ...
                            this.save(this.form)
                                .then(async (res) => {
                                    ...
                                    this.$alert(res);
                                    this.changeWaiting();
                                    this.$emit('crm-close', {created: true, measurement: res.data.measurement});
