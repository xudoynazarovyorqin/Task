<template>
    <div>
        <header id="el-drawer__title" class="el-drawer__header">
            <span> {{ $t('message.new') }} {{ $t('message.product') | lowerFirst }}</span>
            <el-button v-can="['products.create']" type="success" size="small" class="mr-1" :loading="waiting"
                @click="submit(false)"> {{ $t('message.save') }}</el-button>
            <el-button v-can="['products.create']" type="primary" size="small" class="mr-1" :loading="waiting"
                ...
                <el-col :span="24" class="mt-4" v-if="active_step == 1">
                    ...
                    <el-col :span="24">
                        ...
                        <el-col :span="8">
                            ...
                            <categories v-model="form.categories" :categories="form.categories" size="mini"></categories>
