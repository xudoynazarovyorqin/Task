...
<div>
    <header id="el-drawer__title" class="el-drawer__header">
        <span> {{ $t('message.new') }} {{ $t('message.material') | lowerFirst }}</span>
        <el-button v-can="['materials.create']" type="success" size="small" class="mr-1" :loading="waiting"
            @click="submit(false)"> {{ $t('message.save') }}</el-button>
        <el-button v-can="['materials.create']" type="primary" size="small" class="mr-1" :loading="waiting"
