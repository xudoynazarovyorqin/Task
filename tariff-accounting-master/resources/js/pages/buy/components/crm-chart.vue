<template>
    <div class="bg-white p-2 shadow-sm">
        <div class="d-flex bd-highlight border-bottom pt-2">
            <div class="flex-grow-1 bd-highlight">{{ $t('message.buys') }} : <span class="ml-3">  {{ totalSum | formatMoney }}   </span></div>
...
<script>
    ...
    import CrmBarChart from "@/pages/charts/crm-bar-chart";
    export default {
                    ...
                    .then(res => {
                        if (res.data.chart_data){
                            ...
                            this.dataChart = {
                                ...
                                datasets: [
                                    {
                                        label: this.$t('message.buys'),
                                        backgroundColor: '#1245f8',
                                        data: data
                                    }
                                ]
                            };
