        ...
        <div class="mytabel table-sm mr-0 ml-0 p-0">
            <div class="row table-sm mr-0 ml-0 p-0 mb-3 width-100">
                <div class="col-7 p-0 align-self-center font-weight-bold d-flex align-items-center">
                    <h5 class="d-inline mr-2 font-weight-bold">Заезд</h5>
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th v-if="columns.receiverProduct.show">
                            <!-- <el-input clearable size="mini" v-model="filterForm.receiverProduct" :placeholder="columns.receiverProduct.title">
                            </el-input> -->
                        ...
                        <th v-if="columns.typeCar.show">
                             <el-input clearable size="mini" v-model="filterForm.typeCar" :placeholder="columns.typeCar.title">
                            </el-input>
                        </th>
                        <th v-if="columns.railwayNumber.show">
                            <el-date-picker :placeholder="columns.railwayNumber.title" v-model="filterForm.railwayNumber" size="mini">
                            </el-date-picker>
                        </th>
                        ...
                        <th v-if="columns.unloading.show">
                            <el-input clearable size="mini" v-model="filterForm.unloading" :placeholder="columns.unloading.title">
                            </el-input>
                        </th>
    ...
    data() {
        return {
            ...
            list: [
                {
                    "id":'1',
                    "receiverProduct":"OOO LUXULO",
                    "contractNumber":"313U/19",
                    "typeCar":"55K191NA",
                    "railwayNumber":"30 OKT",
                    "innings":"30.окт",
                    "unloading":"172 500",
                    "status":"active",
                },
